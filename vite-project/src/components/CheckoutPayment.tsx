...
export function CheckoutPayment({ lang, handlePromo, methodSelected, handleChengePayment }: CheckoutPaymentProps) {
    ...
    return (
        <div className={isMobile ? classes.paymentWrapper : classes.paymentWrapperDesctop}>
            ...
            <form className={classes.promoCode} onSubmit={(e) => { e.preventDefault(); if (promoRef.current !== null && promoRef.current !== undefined) { handlePromo(promoRef.current.value) } }}>

...
export function Navbar() {
    ...
    return (
        <div className={`${isMobile ? classes.mobile : classes.desctop} ${classes.navWrapper}`}>
            <Link to={'/'} className={classes.logoBack} onClick={() => setSection('QPICK')}>{section}</Link>
            <svg className={classes.cart} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

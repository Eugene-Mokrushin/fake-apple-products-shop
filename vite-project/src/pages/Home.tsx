...
export function Home() {
    ...
    return (
        <div className={classes.homeWrapper}>
            ...
            <div className={classes.cabelType}>
                <div className={`${classes.wrapperType} ${cabelType === lightinigCheker ? classes.active : ''}`} onClick={() => setCableType(lightinigCheker)} >
                    <img src="./wigets/lightningWiget.png" alt="lightinig cables" />
                    <div className={classes.titleType}>{smallLightning}</div>
                </div>
                <div className={`${classes.wrapperType} ${cabelType === jackCheker ? classes.active : ''}`} onClick={() => setCableType(jackCheker)} >
                    <img src="./wigets/jackWiget.png" alt="jack cables" />
                    <div className={classes.titleType}>{smallJack}</div>
                </div>
                <div className={`${classes.wrapperType} ${cabelType === overearsChecker ? classes.active : ''}`} onClick={() => setCableType(overearsChecker)}>
            ...
            <div className={`${cabelType === jackCheker ? classes.shown : classes.hidden}`}>
                <MainStoreSection data={otherAccessories_data.headphones["headphones 3.5mm"].items} header={jack} />
            </div>
